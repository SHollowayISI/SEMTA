...
scenario.traj = struct( ...
    ...
    ...
    'pos_st',   [0.0001; 0; 0], ...          % Position input if 'static' or 'linear' is used
    'vel_st',   [50; 0; 0], ...          % Velocity input if 'static' or 'linear' is used
    ...
    ... % Model options
    'model',    'linear', ...            % Set 'static' or 'model' or 'linear'
    'time',     0 : 100e-6 : 50*10.24);     % Time of simulation in seconds
...
scenario.simsetup = struct( ...
    ...
    'thresh',       15, ...             % Detection threshold above noise power in dB
