...
scenario.multi.radar_pos = ...
    [-4000 * ones(1,scenario.multi.n_re); ...       % Constant x location
...
scenario.traj = struct( ...
    ...
    'exc',      4000, ...               % Excursion distance in meters
    ...
    'time',     0 : 100e-6 : 6*10.24);     % Time of simulation in seconds
