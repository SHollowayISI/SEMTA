...
scenario.multi.radar_pos = ...
    [-2 * nm * ones(1,scenario.multi.n_re); ...       % Constant x location
...
scenario.traj = struct( ...
    ...
    'exc',      1000, ...               % Excursion distance in meters
    ...
    'time',     0 : 100e-6 : 2*10.24);     % Time of simulation in seconds
